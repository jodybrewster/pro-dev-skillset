# AGENTS.md — pro-dev-skillset

Working notes for Codex and Claude Code when editing this marketplace repo itself. Not user-facing — see [README.md](./README.md) for that.
