---
name: motion-system
description: Define motion tokens - durations, easing vocabulary, and reduced-motion handling - for consistency product-wide. Use when standardizing motion across a system. For crafting one specific animation use `motion` or `animate`.
---
# Motion System
