...
description: "Art-direct and implement distinctive, motion-rich marketing, editorial, portfolio, and brand websites: the principles, details, and specific techniques Awwwards-winning sites share, including scroll-based storytelling, subtle animated backgrounds, expensive-feeling effects, standout heroes, GSAP choreography, one smooth-scroll engine, optional Three.js shaders, honest icon and logo sourcing, photo avatars, accessibility, and performance safeguards. Use for an immersive site that should feel award level, or when the user asks for Awwwards-quality, premium, cinematic, interactive, or high-concept work. Use landing-page-design for a conversion page, gsap for one specific hero timeline, and mengto-skills-bridge for the rest of the Meng To effect library."
---
...
_Forked from [MengTo/Skills](https://github.com/MengTo/Skills) - MIT License. See original repository for full license text._
