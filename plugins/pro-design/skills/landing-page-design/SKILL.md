...
description: "Complete system for a landing page rather than a homepage: one offer, one audience, one primary action, with everything on the page structured around that conversion. Asks intake questions first, then designs page structure, layout selection, conversion copywriting, SEO and discoverability, plus a visual system the whole page follows for typography, spacing, corner radius, backgrounds, hero layout, icons, and motion. Use when building, editing, or reviewing a landing page or its copy. General product UI goes to emil-design-eng, immersive award style marketing sites to build-awwwards-quality-sites, anti slop aesthetic families and brand kits to taste-skills-bridge."
---
...
_Forked from [elayadesign/ai-design-skills](https://github.com/elayadesign/ai-design-skills) - MIT License. See original repository for full license text._
