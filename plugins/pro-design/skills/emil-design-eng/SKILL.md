...
description: Start here when building a new product UI screen, component, flow, or app from scratch or from a brief - settings screens, dashboards, forms, modals, navigation, empty and loading states - and it should look properly designed rather than default. This is the default skill for new product UI. It asks clarifying questions before it builds, then works with design-engineering craft, spacing and type discipline, full state coverage, and tasteful motion, encoding Emil Kowalski's philosophy on UI polish and the invisible details that make software feel great. Use impeccable or impeccable-bridge instead for a full redesign, audit, or polish pass over UI that already exists, taste-skill for a quick targeted polish, and landing-page-design or build-awwwards-quality-sites for marketing pages.
---
