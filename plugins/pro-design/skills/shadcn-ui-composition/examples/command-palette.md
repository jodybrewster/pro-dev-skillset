...
<!-- Attribution: Forked from agents-inc/skills (MIT License)
     Upstream path: src/skills/web-ui-shadcn-ui/examples/command-palette.md
     Source: https://github.com/agents-inc/skills -->
