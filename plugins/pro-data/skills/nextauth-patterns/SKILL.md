...
- Extend session with necessary user data (id, role) via callbacks
- Implement proper CSRF protection
- Use middleware for route protection, but also check server-side per route
- Store secrets in environment variables
- Never expose OAuth tokens to the client via session callback

---

_Forked from [a5c-ai/babysitter](https://github.com/a5c-ai/babysitter) — MIT. See original repository for full license text._
