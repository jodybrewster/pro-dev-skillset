...
This is a harness-neutral adapter for upstream GStack workflow `qa`.

- Upstream source: `../../upstream/gstack/qa/SKILL.md`
- Local command: `/gstack-qa`
- Local skill: `gstack-qa`
