# gstack-gstack-openclaw-office-hours Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack-openclaw-office-hours`.

- Upstream source: `../../upstream/gstack/openclaw/skills/gstack-openclaw-office-hours/SKILL.md`
- Local command: `/gstack-gstack-openclaw-office-hours`
- Local skill: `gstack-gstack-openclaw-office-hours`
