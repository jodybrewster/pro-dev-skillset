# gstack-ios-sync Workflow

This is a harness-neutral adapter for upstream GStack workflow `ios-sync`.

- Upstream source: `../../upstream/gstack/ios-sync/SKILL.md`
- Local command: `/gstack-ios-sync`
- Local skill: `gstack-ios-sync`
