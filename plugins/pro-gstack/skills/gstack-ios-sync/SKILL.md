...
description: "Regenerate the iOS debug bridge against the latest upstream gstack templates. Use when the user asks for /gstack-ios-sync, GStack ios-sync, or this GStack-derived workflow."
---
