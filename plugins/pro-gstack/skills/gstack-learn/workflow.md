# gstack-learn Workflow

This is a harness-neutral adapter for upstream GStack workflow `learn`.

- Upstream source: `../../upstream/gstack/learn/SKILL.md`
- Local command: `/gstack-learn`
- Local skill: `gstack-learn`
