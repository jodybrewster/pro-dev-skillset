# gstack-pair-agent Workflow

This is a harness-neutral adapter for upstream GStack workflow `pair-agent`.

- Upstream source: `../../upstream/gstack/pair-agent/SKILL.md`
- Local command: `/gstack-pair-agent`
- Local skill: `gstack-pair-agent`
