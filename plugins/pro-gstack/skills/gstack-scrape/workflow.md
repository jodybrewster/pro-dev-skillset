# gstack-scrape Workflow

This is a harness-neutral adapter for upstream GStack workflow `scrape`.

- Upstream source: `../../upstream/gstack/scrape/SKILL.md`
- Local command: `/gstack-scrape`
- Local skill: `gstack-scrape`
