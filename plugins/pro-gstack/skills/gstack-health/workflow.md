# gstack-health Workflow

This is a harness-neutral adapter for upstream GStack workflow `health`.

- Upstream source: `../../upstream/gstack/health/SKILL.md`
- Local command: `/gstack-health`
- Local skill: `gstack-health`
