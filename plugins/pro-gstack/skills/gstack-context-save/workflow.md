# gstack-context-save Workflow

This is a harness-neutral adapter for upstream GStack workflow `context-save`.

- Upstream source: `../../upstream/gstack/context-save/SKILL.md`
- Local command: `/gstack-context-save`
- Local skill: `gstack-context-save`
