# gstack-browse Workflow

This is a harness-neutral adapter for upstream GStack workflow `browse`.

- Upstream source: `../../upstream/gstack/browse/SKILL.md`
- Local command: `/gstack-browse`
- Local skill: `gstack-browse`
