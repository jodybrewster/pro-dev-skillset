...
This is a harness-neutral adapter for upstream GStack workflow `unfreeze`.

- Upstream source: `../../upstream/gstack/unfreeze/SKILL.md`
- Local command: `/gstack-unfreeze`
- Local skill: `gstack-unfreeze`
