# gstack-gstack-openclaw-investigate Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack-openclaw-investigate`.

- Upstream source: `../../upstream/gstack/openclaw/skills/gstack-openclaw-investigate/SKILL.md`
- Local command: `/gstack-gstack-openclaw-investigate`
- Local skill: `gstack-gstack-openclaw-investigate`
