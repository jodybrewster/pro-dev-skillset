...
description: "Use when asked to debug, fix a bug, investigate an error, or do root cause analysis, and when users report errors, stack traces, unexpected behavior, or say something stopped working. Use when the user asks for /gstack-gstack-openclaw-investigate, GStack gstack-openclaw-investigate, or this GStack-derived workflow."
---
