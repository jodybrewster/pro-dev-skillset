...
description: "Read-only queue dashboard for workspace-aware ship. Use when the user asks for /gstack-landing-report, GStack landing-report, or this GStack-derived workflow."
---
