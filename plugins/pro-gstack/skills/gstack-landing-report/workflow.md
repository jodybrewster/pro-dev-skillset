# gstack-landing-report Workflow

This is a harness-neutral adapter for upstream GStack workflow `landing-report`.

- Upstream source: `../../upstream/gstack/landing-report/SKILL.md`
- Local command: `/gstack-landing-report`
- Local skill: `gstack-landing-report`
