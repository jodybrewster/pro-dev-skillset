...
description: "Self-tuning question sensitivity + developer psychographic for gstack (v1: observational). Use when the user asks for /gstack-plan-tune, GStack plan-tune, or this GStack-derived workflow."
---
