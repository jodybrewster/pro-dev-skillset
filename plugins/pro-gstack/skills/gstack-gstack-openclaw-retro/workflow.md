# gstack-gstack-openclaw-retro Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack-openclaw-retro`.

- Upstream source: `../../upstream/gstack/openclaw/skills/gstack-openclaw-retro/SKILL.md`
- Local command: `/gstack-gstack-openclaw-retro`
- Local skill: `gstack-gstack-openclaw-retro`
