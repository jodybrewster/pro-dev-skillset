# gstack-codex Workflow

This is a harness-neutral adapter for upstream GStack workflow `codex`.

- Upstream source: `../../upstream/gstack/codex/SKILL.md`
- Local command: `/gstack-codex`
- Local skill: `gstack-codex`
