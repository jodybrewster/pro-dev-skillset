...
description: "Turn any markdown file into a publication-quality PDF. Use when the user asks for /gstack-make-pdf, GStack make-pdf, or this GStack-derived workflow."
---
