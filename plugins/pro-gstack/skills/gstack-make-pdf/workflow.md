# gstack-make-pdf Workflow

This is a harness-neutral adapter for upstream GStack workflow `make-pdf`.

- Upstream source: `../../upstream/gstack/make-pdf/SKILL.md`
- Local command: `/gstack-make-pdf`
- Local skill: `gstack-make-pdf`
