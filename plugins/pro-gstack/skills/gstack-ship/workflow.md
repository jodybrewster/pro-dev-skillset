...
This is a harness-neutral adapter for upstream GStack workflow `ship`.

- Upstream source: `../../upstream/gstack/ship/SKILL.md`
- Local command: `/gstack-ship`
- Local skill: `gstack-ship`
