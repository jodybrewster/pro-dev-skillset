---
name: "gstack-ship"
description: "Ship workflow: detect + merge base branch, run tests, review diff, bump VERSION, update CHANGELOG, commit, push, create PR. Use when the user asks for /gstack-ship, GStack ship, or this GStack-derived workflow."
---
