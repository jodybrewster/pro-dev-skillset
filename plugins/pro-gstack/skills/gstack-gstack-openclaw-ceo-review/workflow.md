# gstack-gstack-openclaw-ceo-review Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack-openclaw-ceo-review`.

- Upstream source: `../../upstream/gstack/openclaw/skills/gstack-openclaw-ceo-review/SKILL.md`
- Local command: `/gstack-gstack-openclaw-ceo-review`
- Local skill: `gstack-gstack-openclaw-ceo-review`
