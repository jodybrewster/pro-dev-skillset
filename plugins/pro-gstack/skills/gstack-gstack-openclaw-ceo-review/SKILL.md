...
description: "Use when asked to review a plan, challenge a proposal, run a CEO review, poke holes in an approach, think bigger about scope, or decide whether to expand or reduce the plan. Use when the user asks for /gstack-gstack-openclaw-ceo-review, GStack gstack-openclaw-ceo-review, or this GStack-derived workflow."
---

# gstack-gstack-openclaw-ceo-review
