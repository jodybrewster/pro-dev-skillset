# gstack-office-hours Workflow

This is a harness-neutral adapter for upstream GStack workflow `office-hours`.

- Upstream source: `../../upstream/gstack/office-hours/SKILL.md`
- Local command: `/gstack-office-hours`
- Local skill: `gstack-office-hours`
