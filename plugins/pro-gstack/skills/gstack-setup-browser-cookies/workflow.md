# gstack-setup-browser-cookies Workflow

This is a harness-neutral adapter for upstream GStack workflow `setup-browser-cookies`.

- Upstream source: `../../upstream/gstack/setup-browser-cookies/SKILL.md`
- Local command: `/gstack-setup-browser-cookies`
- Local skill: `gstack-setup-browser-cookies`
