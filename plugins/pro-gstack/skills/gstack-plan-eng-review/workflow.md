# gstack-plan-eng-review Workflow

This is a harness-neutral adapter for upstream GStack workflow `plan-eng-review`.

- Upstream source: `../../upstream/gstack/plan-eng-review/SKILL.md`
- Local command: `/gstack-plan-eng-review`
- Local skill: `gstack-plan-eng-review`
