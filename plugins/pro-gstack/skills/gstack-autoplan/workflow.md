# gstack-autoplan Workflow

This is a harness-neutral adapter for upstream GStack workflow `autoplan`.

- Upstream source: `../../upstream/gstack/autoplan/SKILL.md`
- Local command: `/gstack-autoplan`
- Local skill: `gstack-autoplan`
