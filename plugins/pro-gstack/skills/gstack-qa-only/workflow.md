# gstack-qa-only Workflow

This is a harness-neutral adapter for upstream GStack workflow `qa-only`.

- Upstream source: `../../upstream/gstack/qa-only/SKILL.md`
- Local command: `/gstack-qa-only`
- Local skill: `gstack-qa-only`
