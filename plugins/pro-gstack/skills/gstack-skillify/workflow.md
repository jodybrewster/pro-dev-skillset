# gstack-skillify Workflow

This is a harness-neutral adapter for upstream GStack workflow `skillify`.

- Upstream source: `../../upstream/gstack/skillify/SKILL.md`
- Local command: `/gstack-skillify`
- Local skill: `gstack-skillify`
