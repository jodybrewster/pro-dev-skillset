...
description: "Codify the most recent successful /scrape flow into a permanent browser-skill on disk. Use when the user asks for /gstack-skillify, GStack skillify, or this GStack-derived workflow."
---
