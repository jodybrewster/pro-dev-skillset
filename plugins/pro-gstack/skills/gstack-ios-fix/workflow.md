# gstack-ios-fix Workflow

This is a harness-neutral adapter for upstream GStack workflow `ios-fix`.

- Upstream source: `../../upstream/gstack/ios-fix/SKILL.md`
- Local command: `/gstack-ios-fix`
- Local skill: `gstack-ios-fix`
