...
description: "Scrape the Hacker News front page (titles, points, comment counts). Use when the user asks for /gstack-hackernews-frontpage, GStack hackernews-frontpage, or this GStack-derived workflow."
---
