# gstack-hackernews-frontpage Workflow

This is a harness-neutral adapter for upstream GStack workflow `hackernews-frontpage`.

- Upstream source: `../../upstream/gstack/browser-skills/hackernews-frontpage/SKILL.md`
- Local command: `/gstack-hackernews-frontpage`
- Local skill: `gstack-hackernews-frontpage`
