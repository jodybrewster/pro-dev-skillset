# gstack-gstack Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack`.

- Upstream source: `../../upstream/gstack/SKILL.md`
- Local command: `/gstack-gstack`
- Local skill: `gstack-gstack`
