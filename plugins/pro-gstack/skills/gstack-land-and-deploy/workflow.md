# gstack-land-and-deploy Workflow

This is a harness-neutral adapter for upstream GStack workflow `land-and-deploy`.

- Upstream source: `../../upstream/gstack/land-and-deploy/SKILL.md`
- Local command: `/gstack-land-and-deploy`
- Local skill: `gstack-land-and-deploy`
