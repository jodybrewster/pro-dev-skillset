# gstack-freeze Workflow

This is a harness-neutral adapter for upstream GStack workflow `freeze`.

- Upstream source: `../../upstream/gstack/freeze/SKILL.md`
- Local command: `/gstack-freeze`
- Local skill: `gstack-freeze`
