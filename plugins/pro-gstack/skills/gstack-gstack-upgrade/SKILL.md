...
description: "Upgrade gstack to the latest version. Use when the user asks for /gstack-gstack-upgrade, GStack gstack-upgrade, or this GStack-derived workflow."
---
