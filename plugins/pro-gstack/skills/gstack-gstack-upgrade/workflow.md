# gstack-gstack-upgrade Workflow

This is a harness-neutral adapter for upstream GStack workflow `gstack-upgrade`.

- Upstream source: `../../upstream/gstack/gstack-upgrade/SKILL.md`
- Local command: `/gstack-gstack-upgrade`
- Local skill: `gstack-gstack-upgrade`
