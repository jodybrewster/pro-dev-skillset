# gstack-benchmark Workflow

This is a harness-neutral adapter for upstream GStack workflow `benchmark`.

- Upstream source: `../../upstream/gstack/benchmark/SKILL.md`
- Local command: `/gstack-benchmark`
- Local skill: `gstack-benchmark`
