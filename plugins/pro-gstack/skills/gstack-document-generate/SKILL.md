...
description: "Generate missing documentation from scratch for a feature, module, or entire project. Use when the user asks for /gstack-document-generate, GStack document-generate, or this GStack-derived workflow."
---
