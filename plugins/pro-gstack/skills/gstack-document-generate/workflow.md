# gstack-document-generate Workflow

This is a harness-neutral adapter for upstream GStack workflow `document-generate`.

- Upstream source: `../../upstream/gstack/document-generate/SKILL.md`
- Local command: `/gstack-document-generate`
- Local skill: `gstack-document-generate`
