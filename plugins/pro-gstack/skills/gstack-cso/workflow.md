...
This is a harness-neutral adapter for upstream GStack workflow `cso`.

- Upstream source: `../../upstream/gstack/cso/SKILL.md`
- Local command: `/gstack-cso`
- Local skill: `gstack-cso`
