# gstack-setup-gbrain Workflow

This is a harness-neutral adapter for upstream GStack workflow `setup-gbrain`.

- Upstream source: `../../upstream/gstack/setup-gbrain/SKILL.md`
- Local command: `/gstack-setup-gbrain`
- Local skill: `gstack-setup-gbrain`
