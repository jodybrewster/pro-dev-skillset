...
This is a harness-neutral adapter for upstream GStack workflow `careful`.

- Upstream source: `../../upstream/gstack/careful/SKILL.md`
- Local command: `/gstack-careful`
- Local skill: `gstack-careful`
