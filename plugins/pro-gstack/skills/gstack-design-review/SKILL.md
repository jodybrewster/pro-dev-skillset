...
description: "Designer's eye QA: finds visual inconsistency, spacing issues, hierarchy problems, AI slop patterns, and slow interactions — then fixes them. Use when the user asks for /gstack-design-review, GStack design-review, or this GStack-derived workflow."
---
