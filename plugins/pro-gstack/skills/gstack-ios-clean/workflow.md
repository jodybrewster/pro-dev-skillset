# gstack-ios-clean Workflow

This is a harness-neutral adapter for upstream GStack workflow `ios-clean`.

- Upstream source: `../../upstream/gstack/ios-clean/SKILL.md`
- Local command: `/gstack-ios-clean`
- Local skill: `gstack-ios-clean`
