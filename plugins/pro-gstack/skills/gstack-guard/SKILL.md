---
name: "gstack-guard"
description: "Full safety mode: destructive command warnings + directory-scoped edits. Use when the user asks for /gstack-guard, GStack guard, or this GStack-derived workflow."
---
