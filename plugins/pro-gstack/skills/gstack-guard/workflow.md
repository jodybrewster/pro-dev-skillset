# gstack-guard Workflow

This is a harness-neutral adapter for upstream GStack workflow `guard`.

- Upstream source: `../../upstream/gstack/guard/SKILL.md`
- Local command: `/gstack-guard`
- Local skill: `gstack-guard`
