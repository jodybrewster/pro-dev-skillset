# gstack-open-gstack-browser Workflow

This is a harness-neutral adapter for upstream GStack workflow `open-gstack-browser`.

- Upstream source: `../../upstream/gstack/open-gstack-browser/SKILL.md`
- Local command: `/gstack-open-gstack-browser`
- Local skill: `gstack-open-gstack-browser`
