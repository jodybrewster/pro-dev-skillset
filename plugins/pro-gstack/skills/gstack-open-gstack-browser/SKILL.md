...
description: "Launch GStack Browser — AI-controlled Chromium with the sidebar extension baked in. Use when the user asks for /gstack-open-gstack-browser, GStack open-gstack-browser, or this GStack-derived workflow."
---
