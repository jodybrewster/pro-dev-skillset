# gstack-ios-qa Workflow

This is a harness-neutral adapter for upstream GStack workflow `ios-qa`.

- Upstream source: `../../upstream/gstack/ios-qa/SKILL.md`
- Local command: `/gstack-ios-qa`
- Local skill: `gstack-ios-qa`
