# gstack-document-release Workflow

This is a harness-neutral adapter for upstream GStack workflow `document-release`.

- Upstream source: `../../upstream/gstack/document-release/SKILL.md`
- Local command: `/gstack-document-release`
- Local skill: `gstack-document-release`
