# gstack-sync-gbrain Workflow

This is a harness-neutral adapter for upstream GStack workflow `sync-gbrain`.

- Upstream source: `../../upstream/gstack/sync-gbrain/SKILL.md`
- Local command: `/gstack-sync-gbrain`
- Local skill: `gstack-sync-gbrain`
