# gstack-design-html Workflow

This is a harness-neutral adapter for upstream GStack workflow `design-html`.

- Upstream source: `../../upstream/gstack/design-html/SKILL.md`
- Local command: `/gstack-design-html`
- Local skill: `gstack-design-html`
