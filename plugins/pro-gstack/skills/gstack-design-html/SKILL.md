...
description: "Design finalization: generates production-quality Pretext-native HTML/CSS. Use when the user asks for /gstack-design-html, GStack design-html, or this GStack-derived workflow."
---
