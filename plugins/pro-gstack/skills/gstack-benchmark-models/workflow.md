# gstack-benchmark-models Workflow

This is a harness-neutral adapter for upstream GStack workflow `benchmark-models`.

- Upstream source: `../../upstream/gstack/benchmark-models/SKILL.md`
- Local command: `/gstack-benchmark-models`
- Local skill: `gstack-benchmark-models`
