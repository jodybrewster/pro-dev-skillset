...
description: "Cross-model benchmark for gstack skills. Use when the user asks for /gstack-benchmark-models, GStack benchmark-models, or this GStack-derived workflow."
---
