# gstack-context-restore Workflow

This is a harness-neutral adapter for upstream GStack workflow `context-restore`.

- Upstream source: `../../upstream/gstack/context-restore/SKILL.md`
- Local command: `/gstack-context-restore`
- Local skill: `gstack-context-restore`
