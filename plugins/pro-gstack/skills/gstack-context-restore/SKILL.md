...
description: "Restore working context saved earlier by /context-save. Use when the user asks for /gstack-context-restore, GStack context-restore, or this GStack-derived workflow."
---
