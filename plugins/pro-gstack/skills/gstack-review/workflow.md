...
This is a harness-neutral adapter for upstream GStack workflow `review`.

- Upstream source: `../../upstream/gstack/review/SKILL.md`
- Local command: `/gstack-review`
- Local skill: `gstack-review`
