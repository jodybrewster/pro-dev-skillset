# gstack-canary Workflow

This is a harness-neutral adapter for upstream GStack workflow `canary`.

- Upstream source: `../../upstream/gstack/canary/SKILL.md`
- Local command: `/gstack-canary`
- Local skill: `gstack-canary`
