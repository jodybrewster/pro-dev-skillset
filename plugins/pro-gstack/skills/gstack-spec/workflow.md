# gstack-spec Workflow

This is a harness-neutral adapter for upstream GStack workflow `spec`.

- Upstream source: `../../upstream/gstack/spec/SKILL.md`
- Local command: `/gstack-spec`
- Local skill: `gstack-spec`
