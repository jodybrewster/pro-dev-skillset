# gstack-plan-devex-review Workflow

This is a harness-neutral adapter for upstream GStack workflow `plan-devex-review`.

- Upstream source: `../../upstream/gstack/plan-devex-review/SKILL.md`
- Local command: `/gstack-plan-devex-review`
- Local skill: `gstack-plan-devex-review`
