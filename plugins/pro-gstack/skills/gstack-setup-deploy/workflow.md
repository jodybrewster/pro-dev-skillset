# gstack-setup-deploy Workflow

This is a harness-neutral adapter for upstream GStack workflow `setup-deploy`.

- Upstream source: `../../upstream/gstack/setup-deploy/SKILL.md`
- Local command: `/gstack-setup-deploy`
- Local skill: `gstack-setup-deploy`
