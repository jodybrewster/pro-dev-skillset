# gstack-devex-review Workflow

This is a harness-neutral adapter for upstream GStack workflow `devex-review`.

- Upstream source: `../../upstream/gstack/devex-review/SKILL.md`
- Local command: `/gstack-devex-review`
- Local skill: `gstack-devex-review`
