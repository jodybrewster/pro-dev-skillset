...
description: "Keep gbrain current with this repo's code and refresh agent search guidance in AGENTS.md / CLAUDE.md. Wraps the gstack-gbrain-sync orchestrator with state"
---
